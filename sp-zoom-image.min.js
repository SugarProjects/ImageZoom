(function (root, factory) {
    ...
    spZoom.prototype._init = function() {
        ...
        this.$target.addClass('spZoom').addClass('spZoom--overlay');
        ...
        this.opts.preventClicks && this.$target.on('click.spZoom', function(e) {
            e.preventDefault();
        });
    };
    ...
    spZoom.prototype.show = function(e, testMouseOver) {
        ...
        if (!this.isReady) {
            if ($.isEmptyObject(this.$link)) {
                ...
                console.log('link: ' + $.isEmptyObject(this.$link));
    ...
    spZoom.prototype.teardown = function() {
        ...
        this.$target.removeClass('spZoom').removeClass('spZoom--overlay');
